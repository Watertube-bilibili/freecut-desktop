...
0.4.1 新增移动视频连续播放、真实编辑器双布局和两份桌面应用直连协作验收；窄窗口工具栏自动收紧文字，避免新增协作入口挤出屏幕。实际结果与适用范围见 [0.4.1 验证记录](docs/VERIFICATION-041.md)。旧版安装图标与导出改造记录保留在 [0.3.2 验证记录](docs/VERIFICATION-032.md)。
