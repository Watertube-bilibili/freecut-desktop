...
contextBridge.exposeInMainWorld(
  ...
  Object.freeze({
    ...
    voiceStorageStatus: () => ipcRenderer.invoke('freecut:voice-storage-status'),
    voiceStorageChoose: () => ipcRenderer.invoke('freecut:voice-storage-choose'),
    voiceStorageReset: () => ipcRenderer.invoke('freecut:voice-storage-reset'),
    voiceStorageCopy: () => ipcRenderer.invoke('freecut:voice-storage-copy'),
